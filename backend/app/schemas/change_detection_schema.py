...
class ChangeDetectionResult(BaseModel):
    ...
    unchanged_pixel_count: int = Field(..., description="Number of valid pixels classified as unchanged")
    ...
    changed_area_sqkm: Optional[float] = Field(None, description="Approximate changed area in sq. km based on intersection bounds")
